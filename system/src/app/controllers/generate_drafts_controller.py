...
from system.src.app.usecases.categorisation_usecase.categorisation_usecase import CategorizationUsecase
...
class GenerateDraftsController:
    def __init__(self,
        ...
        categorization_usecase: CategorizationUsecase = Depends(CategorizationUsecase),
    ):
